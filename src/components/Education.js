...
const Service = ({ dark }) => {
  ...
  useEffect(async () => {
    setData(await fatchData("/static/education.json"));
    setTimeout(() => {
  ...
  return (
    <div className="dizme_tm_section" id="education">
      <ServicePopup
        data={popupdata}
        open={popup}
      ...
      <div className="dizme_tm_services">
        <div className="container">
          <div className="dizme_tm_main_title" data-align="center">
            ...
            <p>
              Nurturing my skills and knowledge through formal education and continuous learning
            </p>
          </div>
                        ...
                        <div className="list_inner tilt-effect">
                          ...
                          <div className="title">
                            ...
                            <span className="price">
                              {data.level} - <span>{data.school}</span>
                            </span>
                            <p>{data.year}</p>
                          </div>
                          <div className="text">
